...
class Strategy:
    ...
    def _open_position(self, signal_result: int):
        ...
        # Short is not allowed on Spot platforms (disabled shorts on binance futures too)
        if self.client.platform == "binance_spot" or self.client.platform == "binance_futures" and signal_result == -1:
            return
...
class TechnicalStrategy(Strategy):
    ...
    def _check_signal(self):
        ...
        if macd_line > macd_signal:    # rsi < 30 and macd_line > macd_signal
            return 1
        elif macd_line < macd_signal:  # rsi > 70 and macd_line < macd_signal
            return -1
        else:
            return 0
