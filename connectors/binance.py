...
class BinanceClient:
    def __init__(self, public_key: str, secret_key: str, testnet: bool, futures: bool):
        ...
        if self.futures:
            if testnet:
                logger.info("Binance Futures TestNet Client successfully initialized")
            else:
                logger.info("Binance Futures Client successfully initialized")
        else:
            if testnet:
                logger.info("Binance Spot Testnet Client successfully initialized")
            else:
                logger.info("BinanceUS Spot Client successfully initialized")
    ...
    def get_historical_candles(self, contract: Contract, interval: str) -> typing.List[Candle]:
        ...
        data['limit'] = 1000  # The maximum number of candles is 1000 on BinanceUS Spot
